...
; z poziomu jêzyka C++ (program arytmc_AVX.cpp) w trybie 64  
; bitowym 
public FMA    
...
.code 
FMA: 
;prolog i zapamiêtanie rejestrów 
	push rbp 
	mov rbp,rsp 
	push rbx 
	push rsi 
	...
	mov rsi,rcx  
	mov rdi,rdx   
; utwórz kopiê adresu macierzy A 
; utwórz kopiê adresu macierzy B 
; wyznaczenie liczby powtórzeñ ecx<- count/32 
; d³ugoœæ wektora musi byæ wielokrotnoœci¹ liczby 32 
mov rdx,0 
mov rbx,32 
mov rax,r9 
div rbx 
...
; w³aœciwa pêtla obliczeniowa 
again: 
; xmm2 do pamiêci (czyli mno¿nik scalarA) 
vmovups XMMWORD PTR dana32, xmm2  
; przeniesienie wartosci scalarA do wszystkich 8 czêœci ymm2 
