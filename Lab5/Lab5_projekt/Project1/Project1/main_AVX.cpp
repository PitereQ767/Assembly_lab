...
int main(int argc, char* argv[])
{
	...
	liczba powtórzeñ obliczeñ wynosi
	...
	*/
	...
	// wype³nienie tablicy fa i fb pewnymi wartoœciami 
	...
	printf("Pocz¹tek obliczeñMAXFLOPS_ITERS \n");
	...
	for (j = 0; j < MAXFLOPS_ITERS; j++)
	{
		...
		// obliczenie wartoœci z wykorzystaniem instrukcji 
		// AVX2   fa = a*fa + fb 
